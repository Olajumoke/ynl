...
class EventForm(forms.ModelForm):
    ...
    start_time          = forms.TimeField(required=True, widget=forms.TimeInput(attrs={'class':'form-control timepicker','required':'required'}))
    end_time            = forms.TimeField(required=True, widget=forms.TimeInput(attrs={'class':'form-control timepicker','required':'required'}))
